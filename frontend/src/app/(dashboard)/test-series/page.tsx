        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
          ...
          {(() => {
            ...
            return sortedTestSeries.map((series: any) => {
              ...
              return (
                <Panel key={series.id} className="relative flex flex-col p-0 transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-red-500/10 hover:border-red-500/40 overflow-hidden group bg-white/5 backdrop-blur-xl">
