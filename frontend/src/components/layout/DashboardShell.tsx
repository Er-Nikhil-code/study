...
export default function DashboardShell({
  ...
  return (
    <div 
      ...
      className={`flex-1 flex flex-col bg-[#050505] bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(220,38,38,0.12),rgba(255,255,255,0))] text-white ${!mounted ? "transition-none" : "transition-[padding] duration-300 ease-in-out"} ${sidebarCollapsed ? "pl-[60px]" : "pl-56"}`}
    >
      <AppSidebar 
